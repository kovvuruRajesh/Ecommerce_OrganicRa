                    ...
                    <div className='footer_info'>
                        ...
                        <div style={{display: 'flex', flexDirection: 'column',alignItems:"center",justifyContent:"space-evenly",height:"120%",width:"10rem"}}>
                            ...
                            <div style={{display: 'flex',flexDirection: 'row',justifyContent:"space-evenly",width:"100%"}}>
                                <a href="https://www.facebook.com/share/yZqGNtEuHfjbuJHp/?mibextid=qi2Omg" target="_blank" style={{textDecoration:"none",color:"white"}}><li className='SN'><GrFacebookOption fontSize="1.5rem"/></li></a>

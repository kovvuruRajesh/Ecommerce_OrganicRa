                                ...
                                return(
                                            <div className="order_item">
                                                ...
                                                <div style={{display:'flex',width:"100%",alignItems: 'center',justifyContent:"center"}}>
                                                        <p style={{fontFamily: 'Playfair Display,serif',color:"#001f3f",fontSize:"1.3rem"}}>Rate {order.value['product_name']}:</p>
                                                        <p><Rating size={25} product_id={order.value.product_id}/></p>
                                                </div>
                                        </div>
                                )
                            })

<?php
    ...
    try{
        ...
        $verification_code.'</b><br> Welcome to the family of Organicra</p><br> <img src="https://imagetolink.com/ib/rb8YSBbhv3" alt="Organicra logo" style="width:200px;height:200px;"/>';
        $mail_sent=False;
        if($mail->send()){

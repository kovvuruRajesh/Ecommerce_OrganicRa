                ...
                return(
                    <div className='product_container' style={{height:"500px",border:"1px soild green",borderRadius:"1rem",textDecoration:"none"}}>
                        ...
                        <div style={{display: 'flex',alignItems: 'center'}}>
                            <p style={{fontFamily:'Roboto,sans-serif',display: 'inline-block',fontSize:"1rem"}}>Rating:</p>
                            <p style={{fontFamily:'Roboto,sans-serif',display: 'inline-block'}}><ShowRating rating={data.value.Rating} size={20}/></p>
                        </div>
                        ...
                        <button className="add_to_bag" style={{width:"17rem",marginBottom:"0.5rem",marginTop:"0.5rem"}} onClick={()=>{add_product_to_bag(data.value.Qnt,data.value.id,data.value.name)}}><BsBag/>  Add to bag</button>
                    </div>
                    )
                })}
